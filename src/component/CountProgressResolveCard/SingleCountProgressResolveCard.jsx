...
const SingleCountProgressResolveCard = ({ title, count, gradient }) => {
  return (
    <div
      className={`relative min-h-[180px] md:h-[200px] ${gradient} rounded-xl shadow-lg px-6 md:px-10 py-5 text-white flex flex-col justify-center text-center overflow-hidden`}
    >
      <img
        src={shape1}
        alt=""
